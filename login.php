...
<table align="center">
		<tr>
			<td>username</td>
			<td><input type="text" name="form_username" placeholder="masukan nama pengguna" required></td>
		</tr>
		<tr>
			<td>password</td>
			<td><input type="password" name="form_password" placeholder="masukan kata sandi" required></td>
		</tr>
		<tr>
